[合集 - OpenGL ES(25)](https://github.com)

[1.【OpenGL ES】第一个案例2023-03-20](https://github.com/zhyan8/p/17233730.html)[2.【OpenGL ES】绘制三角形2023-03-20](https://github.com/zhyan8/p/17233729.html)[3.【OpenGL ES】绘制彩色三角形2023-03-20](https://github.com/zhyan8/p/17233728.html)[4.【OpenGL ES】绘制正方形2023-03-20](https://github.com/zhyan8/p/17233727.html)[5.【OpenGL ES】绘制圆形2023-03-20](https://github.com/zhyan8/p/17233726.html)[6.【OpenGL ES】绘制立方体2023-03-20](https://github.com/zhyan8/p/17233725.html)[7.【OpenGL ES】MVP矩阵变换2023-03-20](https://github.com/zhyan8/p/17233724.html)[8.【OpenGL ES】纹理贴图2023-03-20](https://github.com/zhyan8/p/17233723.html)[9.【OpenGL ES】立方体贴图（6张图）2023-03-20](https://github.com/zhyan8/p/17233722.html)[10.【OpenGL ES】绘制魔方2023-03-20](https://github.com/zhyan8/p/17233721.html)[11.【OpenGL ES】立方体手动旋转2023-03-20](https://github.com/zhyan8/p/17233720.html)[12.【OpenGL ES】正方形图片贴到圆形上2023-03-20](https://github.com/zhyan8/p/17233719.html)[13.【OpenGL ES】凸镜贴图2023-03-20](https://github.com/zhyan8/p/17233718.html)[14.【OpenGL ES】透视变换原理2023-03-20](https://github.com/zhyan8/p/17233717.html)[15.【OpenGL ES】渐变凸镜贴图2023-03-20](https://github.com/zhyan8/p/17233716.html):[楚门加速器下载](https://chuman.org)[16.【OpenGL ES】基于ValueAnimator的旋转、平移、缩放动效2023-03-20](https://github.com/zhyan8/p/17233772.html)[17.【OpenGL ES】FBO离屏渲染2023-03-20](https://github.com/zhyan8/p/17233771.html)[18.【OpenGL ES】EGL+FBO离屏渲染2023-03-20](https://github.com/zhyan8/p/17233770.html)[19.【OpenGL ES】Blinn改进的冯氏光照模型2023-03-20](https://github.com/zhyan8/p/17233769.html)[20.【OpenGL ES】光影（光照与阴影）效果2023-03-20](https://github.com/zhyan8/p/17233768.html)[21.【OpenGL ES】渲染管线2023-03-20](https://github.com/zhyan8/p/17233767.html)[22.【OpenGL ES】GLSL基础语法2024-12-29](https://github.com/zhyan8/p/18639011)[23.【OpenGL ES】Windows上OpenGL环境搭建10-07](https://github.com/zhyan8/p/19123022)[24.【OpenGL ES】不用GLSurfaceView，如何渲染图像10-07](https://github.com/zhyan8/p/19123023)

25.【OpenGL ES】在Windows上手撕一个mini版的渲染框架10-06
...
![img](https://img2024.cnblogs.com/blog/3135663/202510/3135663-20251002125133358-811971517.png)
...
​ 经过深思熟虑，笔者给该渲染框架命名为 glcore，命名空间也是 glcore。Windows 上 OpenGL 环境搭建主要有 GLFW / freeglut + Glad / GLEW 方案，详见 → [Windows上OpenGL环境搭建](https://github.com)，本文采用目前广泛使用的 GLFW + Glad 方案。Android 版本的 glcore 实现详见 → [在Android上手撕一个mini版的渲染框架](https://github.com)。

​ 本文完整资源（包含 glcore 框架和第 4 节的应用）详见 →[【OpenGL ES】一个mini版的Windows渲染框架](https://github.com)。
...
​ EGLSurfaceView 主要承载了 EGL 环境搭建。EGL 详细介绍见 → [【OpenGL ES】EGL+FBO离屏渲染](https://github.com)。
...
public:
    VertexBufferObject(bool isStatic, initializer_list attributes);
...
namespace glcore
{
VertexBufferObject::VertexBufferObject(bool isStatic, initializer_list attributes):
...
private:
    vector m_attributes; // 顶点属性列表

public:
    VertexAttributes(initializer_list attributes);
    ~VertexAttributes();
...
namespace glcore
{
VertexAttributes::VertexAttributes(initializer_list attributes):
        m_attributes(attributes)
{
...
public:
    VertexBufferObjectWithVAO(bool isStatic, initializer_list attributes);
...
public:
    Mesh(bool isStatic, initializer_list attributes);
    Mesh(bool isStatic, VertexAttributes* attributes);
    Mesh(bool useVao, bool isStatic, initializer_list attributes);
...
namespace glcore
{
Mesh::Mesh(bool isStatic, initializer_list attributes):
...
Mesh::Mesh(bool useVao, bool isStatic, initializer_list attributes):
...
​ BitmapUtils 用于加载图片资源为位图。为了方便加载各种格式的资源，使用了 stb\_image 工具，详见 → [https://github.com/nothings/stb。](https://github.com)
...
long MyRenderer::getTimestamp()
{
    ...
    return duration_cast(duration).count();
}
```
...
​ 声明：本文转自[【OpenGL ES】在Windows上手撕一个mini版的渲染框架](https://github.com)。
